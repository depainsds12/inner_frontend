...
const Card = ({
  ...
  return (
    <div className={`relative h-fit w-fit ${className.main}`} ref={cardRef}>
      ...
      >
        <section
          className={`z-[-1] flex h-full w-full flex-col`}
          ref={imageTextRef}
        >
          <Image
          ...
          />
          <p
            className={`text-purple-inner-octagon grid w-full flex-grow place-items-center bg-white text-center text-lg font-bold ${className.text}`}
          >
            {text}
          </p>
          ...
          <section className="flex w-full gap-3 px-9 pb-6">
            <Image
              src={avatarIcon ? avatarIcon : HeaderAvatar}
              alt="avatar"
