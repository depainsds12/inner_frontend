...
const InfusionSlider = () => {
  ...
  useEffect(() => {
    if (aiValue >= 0 && aiValue <= 49) {
      meterContainerRef.current.style.background =
        "conic-gradient(#D5D1ED 0deg 90deg, #24AEFF 90deg 270deg, #D5D1ED 270deg 360deg)";
  ...
  return (
    <>
      <div className="flex w-1/2 items-center justify-start gap-[8%] max-sm:gap-[15%]">
        <h2 className="text-[18px] font-semibold text-white">love</h2>
        ...
        <div className="relative z-10 mx-4 flex h-[170px] w-[14px] items-center justify-center p-[3px] transition-opacity ease-in-out max-sm:h-[210px]">
          ...
          >
            ...
            >
              ...
              <div
                className="transition-height ease w-full bg-[#24AEFF]"
                style={{ height: `${value}%` }}
                ref={lowerBlockRef}
              ></div>
            </div>
