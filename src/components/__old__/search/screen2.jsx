  ...
  return (
    ...
    >
      <div className="drop-shadow-clip-outline-white aspect-[2/1.6] h-full max-h-[660px] bg-transparent">
        <section
          className={`aspect-[2/1.6] h-full bg-white`}
          ref={imageTextRef}
        >
          <Image
          ...
          />
          <p className="mt-6 line-clamp-3 px-12 text-base font-semibold lg:text-lg xl:text-xl">
            {text}
          </p>
        </section>
      </div>
      <UserAvatar
        className="drop-shadow-light-purple"
        secClassName="text-base md:text-base lg:text-lg xl:text-xl mx-[-10px]"
        imageClassName="w-[40px] md:w-[50px] lg:w-[60px] xl:w-[70px]"
        textClassName="!py-1 px-3"
      />
      {children}
    </div>
  );
